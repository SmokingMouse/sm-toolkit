...
- **Next**：全量验证并提交 host race 修复，独立 Review 后升级 worker，执行管理员 recovery 验证原 baseline 并清闸，再 Retry generation 3 完成 exact cutover；随后迁移 Mac mini control plane 与双 Device。
