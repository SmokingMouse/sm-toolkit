...
- **Next**：推送后将单控制面/DB/worker从 MacBook cut over 到 Mac mini，重连两台 Device 并做 production smoke；外部真 GitHub/Codebase credential 与 webhook 仍需单独验收。
