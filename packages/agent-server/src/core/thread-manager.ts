...
export interface ThreadManagerOptions extends ModelPolicyOptions { maxQueuedTurns?: number; idleTimeoutMs?: number; interruptTimeoutMs?: number; now?: () => number; allowedRoots?: readonly string[] }
